...
# 1.) Paths
data_dir = "/data/team01/ds340w/datasets/dermnet_split/train"
...
# 3.) Create the Split (70% Train, 10% Test)
train_df, val_df = train_test_split(df, test_size=0.1/0.8, stratify=df['dx'], random_state=17)
