...
output_dir = "/data/team01/ds340w/datasets/ham10000_supersplit"

# 2.) Load Metadata
big_df = pd.read_csv(metadata_path)

# 3.) Super-Split DF (HAM-10000 -> HAM-3000)
df, discard_df = train_test_split(
    big_df, 
    test_size=0.7, 
    stratify=big_df['dx'], 
    random_state=17
...
# 4.) Create the Split (70% Train, 10% Validation, 20% Test)
