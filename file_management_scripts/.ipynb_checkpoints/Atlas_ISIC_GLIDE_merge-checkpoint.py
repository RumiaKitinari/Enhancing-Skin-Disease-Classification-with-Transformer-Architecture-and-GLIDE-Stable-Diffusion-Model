...
reg_dir = '/data/team01/ds340w/datasets/Atlas_ISIC_split/train' 
syn_dir = '/data/team01/ds340w/datasets/GLIDE_synthesis/Atlas_ISIC'
merged_dir = '/data/team01/ds340w/datasets/Atlas_ISIC_GLIDE_merged'
